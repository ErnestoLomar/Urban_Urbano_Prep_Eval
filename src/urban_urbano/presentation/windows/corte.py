...
from urban_urbano.data.repositories.asignaciones_queries import guardar_estado_del_viaje
...
class corte(QWidget):
    ...
    def terminar_vuelta(self, event, imprimir):
        try:
            ...
            self.close()
            try:
                from urban_urbano.infrastructure.printer.impresora import imprimir_ticket_de_corte
            except Exception as e:
