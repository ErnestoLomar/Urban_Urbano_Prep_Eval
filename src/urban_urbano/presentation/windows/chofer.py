...
# Librerías propias
from urban_urbano.data.repositories.servicio_pensiones import obtener_servicios_de_pension, obtener_pensiones
import urban_urbano.config.variables_globales as vg
from urban_urbano.config.variables_globales import VentanaActual
from urban_urbano.data.repositories.asignaciones_queries import (
...
from urban_urbano.data.repositories.queries import obtener_datos_aforo
from urban_urbano.data.repositories.matrices_tarifarias import (
...
from urban_urbano.presentation.windows.emergentes import VentanaEmergente
