...
from urban_urbano.infrastructure.hardware.hw import HUB

# Librerías propias
from urban_urbano.data.repositories.ventas_queries import insertar_venta, insertar_item_venta, obtener_ultimo_folio_de_item_venta
from urban_urbano.data.repositories.queries import obtener_datos_aforo, insertar_estadisticas_boletera
...
from urban_urbano.presentation.windows.prepago import VentanaPrepago
...
class VentanaPasaje(QWidget):
    ...
    def handle_pagar(self, event):
        try:
            ...
            try:
                from urban_urbano.infrastructure.printer.impresora import (
