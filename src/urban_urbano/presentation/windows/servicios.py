...
# Hub GPIO (BCM)
try:
    from urban_urbano.infrastructure.gpio.gpio_hub import GPIOHub, PINMAP
    HUB = GPIOHub(PINMAP)
...
# Librerías propias
from urban_urbano.presentation.windows.pasaje import VentanaPasaje
import urban_urbano.config.variables_globales as variables_globales
from urban_urbano.config.variables_globales import VentanaActual, distancia_minima
from urban_urbano.data.repositories.matrices_tarifarias import obtener_servicio_por_numero_de_servicio_y_origen, obtener_transbordos_por_origen_y_numero_de_servicio
from urban_urbano.data.repositories.servicio_pensiones import obtener_origen_por_numero_de_servicio
from urban_urbano.data.repositories.geocercas_db import obtener_geocerca_de_servicio
from urban_urbano.shared.calcular_distancia_geocerca import calcular_distancia
from urban_urbano.workers.Detectar_geocercas import DeteccionGeocercasWorker
