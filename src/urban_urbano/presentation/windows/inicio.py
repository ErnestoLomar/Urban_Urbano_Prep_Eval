...
# Librerías propias
from urban_urbano.presentation.windows.chofer import VentanaChofer
from urban_urbano.infrastructure.hardware.eeprom_num_serie import cargar_num_serie
from urban_urbano.infrastructure.minicom.comand import Principal_Modem
from urban_urbano.data.repositories.queries import crear_tablas
import urban_urbano.config.variables_globales as variables_globales
from urban_urbano.config.variables_globales import VentanaActual
from urban_urbano.workers.LeerMinicom import LeerMinicomWorker
from urban_urbano.workers.LeerTarjeta import LeerTarjetaWorker
from urban_urbano.workers.ActualizarIconos import ActualizarIconosWorker
from urban_urbano.presentation.windows.servicios import Rutas
from urban_urbano.data.repositories.queries import (
    obtener_datos_aforo,
    insertar_aforo,
    insertar_estadisticas_boletera,
    actualizar_socket,
)
from urban_urbano.presentation.windows.enviar_vuelta import EnviarVuelta
from urban_urbano.presentation.windows.emergentes import VentanaEmergente  # para mostrar mensajes desde hilos
...
if __name__ == '__main__':
    ...
    GUI = Ventana()
    GUI.show()
    from urban_urbano.presentation.navigation.abrir_ventanas import AbrirVentanas
