...
#Librerias propias
from urban_urbano.infrastructure.minicom.comand import Comunicacion_Minicom, Principal_Modem
import urban_urbano.config.variables_globales as variables_globales
from urban_urbano.data.repositories.queries import obtener_datos_aforo, obtener_estadisticas_no_enviadas, actualizar_estado_estadistica_check_servidor, insertar_estadisticas_boletera, obtener_ultima_ACT, eliminar_todas_las_estadisticas_ACT_no_hechas
from urban_urbano.data.repositories.asignaciones_queries import guardar_actualizacion, obtener_asignaciones_no_enviadas, actualizar_asignacion_check_servidor, obtener_todas_las_asignaciones_no_enviadas
import urban_urbano.config.variables_globales as variables_globales
from urban_urbano.infrastructure.minicom.comand import Comunicacion_Minicom, Principal_Modem
import urban_urbano.config.variables_globales as variables_globales
from urban_urbano.data.repositories.folio import cargarFolioActual, actualizar_folio
from urban_urbano.data.repositories.asignaciones_queries import actualizar_estado_del_viaje_check_servidor, obtener_estado_de_viajes_no_enviados, obtener_asignacion_por_folio_de_viaje, obtener_fin_de_viaje_por_folio_de_viaje
from urban_urbano.data.repositories.ventas_queries import obtener_estado_de_ventas_no_enviadas, actualizar_estado_venta_check_servidor, obtener_venta_por_folio_y_foliodeviaje, obtener_estado_de_todas_las_ventas_no_enviadas, obtener_ventas_digitales_no_enviadas, actualizar_estado_venta_digital_check_servidor
from urban_urbano.data.repositories.horariosDB import actualizar_estado_hora_check_hecho, obtener_estado_de_todas_las_horas_no_hechas, actualizar_estado_hora_por_defecto
from scripts.actualizar import Actualizar
