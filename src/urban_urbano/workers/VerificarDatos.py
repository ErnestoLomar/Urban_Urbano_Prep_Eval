...
from urban_urbano.data.repositories.ventas_queries import obtener_estado_de_todass_las_ventas_no_enviadas, obtener_ventas_digitales_no_enviadas
from urban_urbano.data.repositories.asignaciones_queries import obtener_todass_las_asignaciones_no_enviadas, obtener_estado_de_todos_los_viajes_no_enviados
