...
# Librerías locales
from urban_urbano.data.repositories.asignaciones_queries import seleccionar_auto_asignaciones_antiguas, eliminar_auto_asignaciones_antiguas, seleccionar_fin_de_viaje_antiguos, eliminar_fin_de_viaje_antiguos
from urban_urbano.data.repositories.tickets_usados import seleccionar_tickets_antiguos, eliminar_tickets_antiguos
from urban_urbano.data.repositories.ventas_queries import seleccionar_ventas_antiguas, eliminar_ventas_antiguas, seleccionar_ventas_digitales_antiguas, eliminar_ventas_digitales_antiguas
from urban_urbano.data.repositories.queries import insertar_estadisticas_boletera, crear_tablas, obtener_datos_aforo, seleccionar_estadistias_antiguas, eliminar_estadisticas_antiguas, actualizar_socket
from urban_urbano.data.repositories.horariosDB import obtener_estado_de_todas_las_horas_no_hechas, actualizar_estado_hora_check_hecho, actualizar_estado_hora_por_defecto
import urban_urbano.config.variables_globales as vg 
from urban_urbano.infrastructure.hardware.eeprom_num_serie import cargar_num_serie
from urban_urbano.infrastructure.ftp.FTP import Principal_Modem
