...
from urban_urbano.data.repositories.tickets_usados import insertar_ticket_usado, verificar_ticket_completo, verificar_ticket
import urban_urbano.config.variables_globales as vg
from urban_urbano.infrastructure.hardware.hw import HUB

from urban_urbano.workers.nfc_reader_proc import nfc_reader_main
        ...
        try:
            while self._running:
                ...
                try:
                    ...
                    try:
                        from urban_urbano.infrastructure.printer.impresora import imprimir_boleto_normal_sin_servicio, imprimir_boleto_normal_con_servicio
                    except Exception as e:
                        logging.info(e)
