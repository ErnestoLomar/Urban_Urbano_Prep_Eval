...
from urban_urbano.data.repositories.asignaciones_queries import obtener_ultimo_folio_asignaciones
from urban_urbano.data.repositories.rutas_queries import obtener_ultimo_folio_asistencia
